...
export const HeroBanner: React.FC = () => {
  return (
    <div className="highlight w-full lg:h-auto bg-base-100 cursor-pointer sm:grid flex flex-col rounded-xl">
      <img
      ...
      <div className="md:pl-5 pl-4 pb-2 md:pb-0 pt-2 pr-2 md:pr-5 lg:p-7 xl:p-8">
        ...
        >
          ...
          arcu eget lectus bibendum, vitae aliquet metus dignissim.
        </p>
